...
def run(occurence, params):
    ...
    comp = rootComp.occurrences.item(rootComp.occurrences.count-1).component
    if (hw_max == 0 or dw == 0):
        comp.features.extrudeFeatures.itemByName("Extrude5").deleteMe()
        comp.sketches.itemByName("Sketch7").deleteMe()

    # if (hw_max == 0 and l1 == 0 and l2 == 0 and h1 == 0):
    #     comp.features.filletFeauters.itemByName("Fillet1").deleteMe()
    #     comp.features.filletFeauters.itemByName("Fillet2").deleteMe()
    #     comp.features.filletFeauters.itemByName("Fillet3").deleteMe()
